...
type FlatConfig struct {
	...
	OutputImageDescription *string           `mapstructure:"output_image_description" required:"false" cty:"output_image_description" hcl:"output_image_description"`
	...
	UnixSocketPath         *string           `mapstructure:"unix_socket_path" required:"true" cty:"unix_socket_path" hcl:"unix_socket_path"`
	CompressionAlgorithm   *string           `mapstructure:"compression_algorithm" required:"false" cty:"compression_algorithm" hcl:"compression_algorithm"`
}
...
func (*FlatConfig) HCL2Spec() map[string]hcldec.Spec {
	s := map[string]hcldec.Spec{
		...
		"output_image_description":   &hcldec.AttrSpec{Name: "output_image_description", Type: cty.String, Required: false},
